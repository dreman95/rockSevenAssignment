...
* after the all calculations were made i used thymeleaf to present the data in a HTML document which can be found in the root of this repo(boatSightingsTable.hmtl)